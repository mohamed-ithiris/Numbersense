...
function CreateBotCreator() {
  ...
  const handleCreateClick = () => {
    ...
    if (!submit) {
      ...
      dispatch(
        Creators.putBotCreator(form, (response) => {
        ...
        <div className="LessonBotHeader">
          ...
          >
            ...
            <Typography sx={{ display: "flex", alignItems: "center" }}>
              <Tooltip title="Create Bot Creator">
                <CreateIcon sx={{ mr: 0.5 }} fontSize="medium" />
              </Tooltip>
              <span className="BreadcrumbName">Create Bot Creator</span>
            </Typography>
          </Breadcrumbs>
        </div>
...
export default CreateBotCreator;
